...
<main>
	...
	<p>
		<span contenteditable="true" bind:textContent={lastChangeText}></span> since last change
	</p>
	<p>
		<span contenteditable="true" bind:textContent={elapsedText}></span> since start
	</p>
	<p>
		<span contenteditable="true" bind:textContent={cpmText}></span> characters/min
	</p>
	<p>
		<span contenteditable="true" bind:textContent={wpmText}></span> words/min
	</p>
	<p>
		<span contenteditable="true" bind:textContent={errText}></span> % errors
	</p>
